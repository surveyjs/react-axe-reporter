  ...
  return (
    <div className={styles.Container_24901_1291670}>
        ...
        <div className={styles.HeaderCell_4_24901_1291675}>
            <div className={styles.Container_24893_918952}>
            <div className={styles.Content_24893_918953}><span className={styles.Text_24893_918958}>Issues</span></div>
            <div className={styles.Sizer_24893_918959}>
                <div className={styles.Nothing_24893_918960}></div>
            </div>
            </div>
        ...
        <div className={styles.axe_rule_report_row}>
            ...
            <div className={styles.TableCellDoc_24901_1291680}>
                <div className={styles.Container_24893_919087}>
                <div className={styles.Content_24893_919088}><span className={styles.Text_24893_919093}>{rule.help}</span></div>
                <div className={styles.Sizer_24893_919094}>
                    <div className={styles.Nothing_24893_919095}></div>
                </div>
                </div>
            </div>
            <div className={styles.TableCellDoc_24901_1291681}>
                <div className={styles.Container_25515_30865}>
                ...
                <div className={styles.Sizer_25515_30868}>
                    <div className={styles.Nothing_25515_30869}></div>
                </div>
                </div>
            </div>
